...
MagicISO drivers require Reboot Windows in SafeMode and Dissable 7 Driver Enforcement, and install as Administrator and/or allow Windows to load testsigned drivers with cmd "bcdedit /set testsigning on" </br>
